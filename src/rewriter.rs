...
pub enum RewriteResult {
    ...
    /// The stream is already normalized so there is no need to rewrite it. Any
    /// partial result generated by the `Rewriter` should be discarded and
    /// no further packets submitted.
    AlreadyNormalized,
}
