...
Opus files. Its usuage is roughly based on that of `vorbiscomment`.
...
* `-c COMMENT_FILE, --commentfile COMMENT_FILE`: In append and write modes, the
  ...
  the command line.  In list mode, tags will be written to this file.
